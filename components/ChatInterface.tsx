...
`;
  ...
  const handleSendQuestion = async () => {
    ...
    try {
      ...
      if (!response.ok)
        throw new Error("The AI is a bit tired, please try again.");
          ...
          <div className="pt-4">
            ...
            {checkinStep === "time" && !isLoading && (
              <div className="flex justify-center flex-wrap gap-2">
                ...
                <Button variant="outline" onClick={() => handleTimeSelect(30)}>
                  30 min (Standard)
                </Button>

                <Button variant="outline" onClick={() => handleTimeSelect(45)}>
                  45+ min (Full session)
                </Button>
